import 'package:quan_li_nhan_vien/CanBoQuanLy.dart';
...
void main() {
    ...
    List<Nhanvien> lstLoaiA =
    lstNhanVien.where((a) => a.xepLoai() == "A").toList();
    ...
    lstNhanVien.sort((x, y) =>
    x.tinhLuong().compareTo(y.tinhLuong()));
