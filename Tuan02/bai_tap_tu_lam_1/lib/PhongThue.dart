abstract class PhongThue{
  ...
  PhongThue.fullPara(String maPhong, int soNguoi, double soDien, double soNuoc) {
    _maPhong = maPhong;
    _soNguoi = soNguoi;
    _soDien = soDien;
    _soNuoc = soNuoc;
  ...
  void showInfo() {
    print(
      "Mã: $_maPhong | Số người: $_soNguoi | Điện: $_soDien | Nước: $_soNuoc | Tiền phòng: ${tinhTienPhong()}",
    );
  }
}
